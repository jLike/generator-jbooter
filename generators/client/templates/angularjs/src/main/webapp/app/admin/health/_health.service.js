...
(function() {
    ...
    angular
        ...
        .factory('<%=jbtPrefixCapitalized%>HealthService', <%=jbtPrefixCapitalized%>HealthService);

    <%=jbtPrefixCapitalized%>HealthService.$inject = ['$rootScope', '$http'];

    function <%=jbtPrefixCapitalized%>HealthService ($rootScope, $http) {
        var separator = '.';
        var service = {
