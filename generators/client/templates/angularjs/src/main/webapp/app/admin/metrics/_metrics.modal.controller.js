...
(function() {
    ...
    angular
        ...
        .controller('<%=jbtPrefixCapitalized%>MetricsMonitoringModalController', <%=jbtPrefixCapitalized%>MetricsMonitoringModalController);

    <%=jbtPrefixCapitalized%>MetricsMonitoringModalController.$inject = ['$uibModalInstance', 'threadDump'];

    function <%=jbtPrefixCapitalized%>MetricsMonitoringModalController ($uibModalInstance, threadDump) {
        var vm = this;
