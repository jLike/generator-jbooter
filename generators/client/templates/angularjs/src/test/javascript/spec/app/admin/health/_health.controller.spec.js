...
describe('Controller Tests', function () {
    ...
    describe('<%=jbtPrefixCapitalized%>HealthCheckController', function () {
        var $scope, jbtHealthService; // actual implementations
        var createController; // local utility functions

        beforeEach(inject(function ($injector, <%=jbtPrefixCapitalized%>HealthService) {
            $scope = $injector.get('$rootScope').$new();
            jbtHealthService = <%=jbtPrefixCapitalized%>HealthService;
            var locals = {
                '$scope': $scope
            };
            createController = function() {
                $injector.get('$controller')('<%=jbtPrefixCapitalized%>HealthCheckController as vm', locals);
            };
            createController();
        }));
        ...
        describe('transformHealthData', function () {
            it('should flatten empty health data', function () {
                var data = {};
                var expected = [];
                expect(jbtHealthService.transformHealthData(data)).toEqual(expected);
            });
