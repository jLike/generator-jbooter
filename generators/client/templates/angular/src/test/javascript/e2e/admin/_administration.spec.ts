...
if (enableTranslation) {
    elementGetter = `getAttribute('jbtTranslate')`;
} _%>
...
describe('administration', () => {
    ...
    it('should load metrics', () => {
        element(by.css('[routerLink="<%=jbtPrefix%>-metrics"]')).click();
        <%_ if (enableTranslation) { _%>
    ...
    it('should load health', () => {
        element(by.css('[routerLink="<%=jbtPrefix%>-health"]')).click();
        <%_ if (enableTranslation) { _%>
    ...
    it('should load configuration', () => {
        element(by.css('[routerLink="<%=jbtPrefix%>-configuration"]')).click();
        <%_ if (enableTranslation) { _%>
