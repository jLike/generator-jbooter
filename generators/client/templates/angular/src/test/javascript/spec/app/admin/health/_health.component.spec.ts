...
import { <%=jbtPrefixCapitalized%>HealthCheckComponent } from '../../../../../../main/webapp/app/admin/health/health.component';
import { <%=jbtPrefixCapitalized%>HealthService } from '../../../../../../main/webapp/app/admin/health/health.service';


describe('Component Tests', () => {

    describe('<%=jbtPrefixCapitalized%>HealthCheckComponent', () => {

        let comp: <%=jbtPrefixCapitalized%>HealthCheckComponent;
        let fixture: ComponentFixture<<%=jbtPrefixCapitalized%>HealthCheckComponent>;
        let service: <%=jbtPrefixCapitalized%>HealthService;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [<%=angular2AppName%>TestModule],
                declarations: [<%=jbtPrefixCapitalized%>HealthCheckComponent],
                providers: [
            ...
            }).overrideTemplate(<%=jbtPrefixCapitalized%>HealthCheckComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(<%=jbtPrefixCapitalized%>HealthCheckComponent);
            comp = fixture.componentInstance;
            service = fixture.debugElement.injector.get(<%=jbtPrefixCapitalized%>HealthService);
        });
