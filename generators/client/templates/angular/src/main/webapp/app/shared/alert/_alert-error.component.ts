...
<%_ } _%>
import { EventManager, AlertService } from 'ng-jbooter';
import { Subscription } from 'rxjs/Rx';

@Component({
    selector: '<%=jbtPrefix%>-alert-error',
    template: `
...
export class <%=jbtPrefixCapitalized%>AlertErrorComponent implements OnDestroy {
