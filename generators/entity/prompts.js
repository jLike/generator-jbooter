...
function askForPagination() {
    ...
    // Check the issue https://github.com/jbooter/generator-jbooter/issues/5007 for more details
    ...
    const prompts = [
        ...
        },
        {
            ...
            validate: (input) => {
                ...
                } else if (!skipServer && jbtCore.isReservedFieldName(input)) {
        ...
        },
        {
            ...
            validate: (input) => {
                ...
                } else if (jbtCore.isReservedKeyword(input, 'JAVA')) {
