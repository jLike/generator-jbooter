...
import { EventManager, AlertService<% if (fieldsContainBlob) { %>, DataUtils<% } %> } from 'ng-jbooter';
...
@Component({
    selector: '<%= jbtPrefix %>-<%= entityFileName %>-dialog',
...
@Component({
    selector: '<%= jbtPrefix %>-<%= entityFileName %>-popup',
    template: ''
})
