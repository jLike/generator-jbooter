...
module.exports = ExportJDLGenerator.extend({
    constructor: function (...args) { // eslint-disable-line object-shorthand
        ...
        this.jdl = new jbtCore.JDLObject();
    ...
    default: {
        ...
        parseJson() {
            ...
            try {
                ...
                jbtCore.convertJsonEntitiesToJDL(entities, this.jdl);
                jbtCore.convertJsonServerOptionsToJDL({ 'generator-jbooter': this.config.getAll() }, this.jdl);
            } catch (e) {
    ...
    writing() {
        const content = `// JDL definition for application '${this.baseName}' generated with command 'jbooter export-jdl'\n\n${this.jdl.toString()}`;
