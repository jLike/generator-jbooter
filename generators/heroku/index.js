    ...
    default: {
        ...
        configureJBooterRegistry() {
            ...
            if (this.applicationType === 'microservice' || this.applicationType === 'gateway') {
                ...
                this.log('');
                this.prompt(prompts).then((props) => {
                    const configSetCmd = `heroku config:set JBOOTER_REGISTRY_URL=${props.herokuJBooterRegistry} --app ${this.herokuAppName}`;
