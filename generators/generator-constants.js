...
const DOCKER_JBOOTER_REGISTRY = 'jbooter/jbooter-registry:v3.0.1';
...
const DOCKER_JBOOTER_CONSOLE = 'jbooter/jbooter-console:v2.0.1';
const DOCKER_JBOOTER_ELASTICSEARCH = 'jbooter/jbooter-elasticsearch:v2.0.1';
const DOCKER_JBOOTER_LOGSTASH = 'jbooter/jbooter-logstash:v2.0.1';
const DOCKER_JBOOTER_ZIPKIN = 'jbooter/jbooter-zipkin:v2.0.1';
const DOCKER_CONSUL = 'consul:0.7.2';
const DOCKER_CONSUL_CONFIG_LOADER = 'jbooter/consul-config-loader:v0.2.1';
...
const constants = {
    ...
    JBOOTER_DOCUMENTATION_URL,
    JBOOTER_DOCUMENTATION_ARCHIVE_PATH,

    DOCKER_JBOOTER_REGISTRY,
    DOCKER_JAVA_JRE,
    DOCKER_MYSQL,
    DOCKER_MARIADB,
    DOCKER_POSTGRESQL,
    ...
    DOCKER_ZOOKEEPER,
    DOCKER_SONAR,
    DOCKER_JBOOTER_CONSOLE,
    DOCKER_JBOOTER_ELASTICSEARCH,
    DOCKER_JBOOTER_LOGSTASH,
    DOCKER_JBOOTER_ZIPKIN,
    DOCKER_CONSUL,
