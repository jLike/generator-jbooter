...
module.exports = DockerComposeGenerator.extend({
    ...
    initializing: {
        sayHello() {
            this.log(chalk.white(`${chalk.bold('🐳')}  Welcome to the JBooter Docker Compose Sub-Generator ${chalk.bold('🐳')}`));
        ...
        setupServerconsts() {
            ...
            this.DOCKER_JBOOTER_ZIPKIN = constants.DOCKER_JBOOTER_ZIPKIN;
        ...
        setAppsYaml() {
            ...
            this.appsFolders.forEach((appsFolder, index) => {
                ...
                if (this.serviceDiscoveryType === 'eureka') {
                    // Set the JBooter Registry password
                    yamlConfig.environment.push(`JBOOTER_REGISTRY_PASSWORD=${this.adminPassword}`);
                }
