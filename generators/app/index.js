...
const JbooterGenerator = generator.extend({});

util.inherits(JbooterGenerator, BaseGenerator);
...
module.exports = JbooterGenerator.extend({
    constructor: function (...args) { // eslint-disable-line object-shorthand
        ...
        // This adds support for a `--jbt-prefix` flag
        this.option('jbt-prefix', {
        ...
        this.jbtPrefix = this.configOptions.jbtPrefix || this.config.get('jbtPrefix') || this.options['jbt-prefix'];
    ...
    default: {
        ...
        saveConfig() {
            ...
            this.config.set('jbtPrefix', this.jbtPrefix);
            ...
            if (this.skipClient) {
                ...
                if (!this.options['skip-install']) {
                    if (this.clientPackageManager === 'yarn') {
                        this.log(chalk.bold(`\nInstalling generator-jbooter@${this.jbooterVersion} locally using yarn`));
                        this.spawnCommand('yarn', ['install']);
                    } else if (this.clientPackageManager === 'npm') {
                        this.log(chalk.bold(`\nInstalling generator-jbooter@${this.jbooterVersion} locally using npm`));
                        this.npmInstall();
                    }
                }
            }
