...
module.exports = JDLGenerator.extend({
    ...
    default: {
        ...
        parseJDL() {
            ...
            try {
                const jdlObject = jbtCore.convertToJDL(jbtCore.parseFromFiles(this.jdlFiles), this.prodDatabaseType, this.applicationType);
                const entities = jbtCore.convertToJBooterJSON({
                    jdlObject,
                    databaseType: this.prodDatabaseType
                });
                this.log('Writing entity JSON files.');
                jbtCore.exportToJSON(entities, this.options.force);
            } catch (e) {
                this.log(e);
