...
const AwsFactory = module.exports = function AwsFactory(generatorRef, cb) {
    ...
    try {
        ...
        let installCommand = 'yarn add aws-sdk progress uuid --modules-folder node_modules/generator-jbooter/node_modules';
        if (generator.config.get('clientPackageManager') === 'npm') {
            installCommand = 'npm install aws-sdk progress uuid --prefix node_modules/generator-jbooter';
        }
