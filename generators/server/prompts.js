...
function askForServerSideOpts() {
    ...
    const prompts = [
        ...
        },
        {
            ...
            message: response => this.getNumberedQuestion(
                'Do you want to use the JBooter Registry to configure, monitor and scale your microservices and gateways?',
                applicationType === 'gateway' || applicationType === 'microservice' || applicationType === 'uaa'
            ),
            choices: [
                {
        ...
        },
        {
            ...
            name: 'serviceDiscoveryType',
            message: response => this.getNumberedQuestion(
                'Do you want to use the JBooter Registry to configure, monitor and scale your application?',
    ...
    this.prompt(prompts).then((props) => {
        ...
        // JWT authentication is mandatory with Eureka, so the JBooter Registry
