...
public class UserResourceIntTest <% if (databaseType === 'cassandra') { %>extends AbstractCassandraTest <% } %>{
    ...
    private static final String UPDATED_LOGIN = "jbooter";

    private static final String DEFAULT_PASSWORD = "passjohndoe";
    private static final String UPDATED_PASSWORD = "passjbooter";

    private static final String DEFAULT_EMAIL = "johndoe@localhost";
    private static final String UPDATED_EMAIL = "jbooter@localhost";

    private static final String DEFAULT_FIRSTNAME = "john";
    private static final String UPDATED_FIRSTNAME = "jbooterFirstName";

    private static final String DEFAULT_LASTNAME = "doe";
    private static final String UPDATED_LASTNAME = "jbooterLastName";
    ...
    public void updateUserExistingEmail() throws Exception {
        ...
        <%_ } _%>
        anotherUser.setLogin("jbooter");
        anotherUser.setPassword(RandomStringUtils.random(60));
        anotherUser.setActivated(true);
        anotherUser.setEmail("jbooter@localhost");
        ...
        ManagedUserVM managedUserVM = new ManagedUserVM(
            ...
            "jbooter@localhost",  // this email should already be used by anotherUser
            updatedUser.getActivated(),
            <%_ if (databaseType !== 'cassandra') { _%>
    ...
    public void updateUserExistingLogin() throws Exception {
        ...
        ManagedUserVM managedUserVM = new ManagedUserVM(
            updatedUser.getId(),
            "jbooter", // this login should already be used by anotherUser
            updatedUser.getPassword(),
            updatedUser.getFirstName(),
            updatedUser.getLastName(),
