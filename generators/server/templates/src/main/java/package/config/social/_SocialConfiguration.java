...
public class SocialConfiguration implements SocialConfigurer {
    ...
    @Bean
    public SignInAdapter signInAdapter(UserDetailsService userDetailsService, JBooterProperties jBooterProperties<% if (authenticationType == 'jwt') { %>,
            TokenProvider tokenProvider<% } %>) {
        return new CustomSignInAdapter(userDetailsService, jBooterProperties<% if (authenticationType == 'jwt') { %>,
            tokenProvider<% } %>);
    }
