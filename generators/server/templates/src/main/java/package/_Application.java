...
public class <%= mainClass %> {
    ...
    public void initApplication() {
        ...
        if (activeProfiles.contains(JBooterConstants.SPRING_PROFILE_DEVELOPMENT) && activeProfiles.contains(JBooterConstants.SPRING_PROFILE_PRODUCTION)) {
            log.error("You have misconfigured your application! It should not run " +
                "with both the 'dev' and 'prod' profiles at the same time.");
        }
        if (activeProfiles.contains(JBooterConstants.SPRING_PROFILE_DEVELOPMENT) && activeProfiles.contains(JBooterConstants.SPRING_PROFILE_CLOUD)) {
