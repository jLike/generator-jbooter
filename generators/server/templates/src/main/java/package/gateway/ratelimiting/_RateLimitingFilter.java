...
public class RateLimitingFilter extends ZuulFilter {
    ...
    public RateLimitingFilter(JBooterProperties jBooterProperties) {
    ...
    private Supplier<BucketConfiguration> getConfigSupplier() {
        return () -> {
            JBooterProperties.Gateway.RateLimiting rateLimitingProperties =
                jBooterProperties.getGateway().getRateLimiting();
