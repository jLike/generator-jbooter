    ...
    return {
        ...
        writeDockerFiles() {
            ...
            if (this.serviceDiscoveryType) {
                ...
                if (this.serviceDiscoveryType === 'eureka') {
                    this.template(`${DOCKER_DIR}_jbooter-registry.yml`, `${DOCKER_DIR}jbooter-registry.yml`);
        ...
        writeServerJavaConfigFiles() {
            ...
            if (this.databaseType === 'cassandra') {
                ...
                this.template(`${SERVER_MAIN_SRC_DIR}package/config/metrics/_JBooterHealthIndicatorConfiguration.java`, `${javaDir}config/metrics/JBooterHealthIndicatorConfiguration.java`);
