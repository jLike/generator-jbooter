    ...
    return {
        ...
        writeRegistryFiles() {
            ...
            if (this.serviceDiscoveryType === 'eureka') {
                this.template('registry/_jbooter-registry.yml', `${this.directoryPath}/ocp/registry/jbooter-registry.yml`);
        ...
        writeElkFiles() {
            ...
            this.template('monitoring/_jbooter-monitoring.yml', `${this.directoryPath}/ocp/monitoring/jbooter-monitoring.yml`);
        },
        ...
        writePrometheusFiles() {
            ...
            this.template('monitoring/_jbooter-metrics.yml', `${this.directoryPath}/ocp/monitoring/jbooter-metrics.yml`);
        },
