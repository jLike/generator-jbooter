module.exports = {
    app: {
        default: true,
        desc: 'Create a new JBooter application based on the selected options'
    },
    aws: {
    ...
    client: {
        desc: 'Create a new JBooter client-side application based on the selected options'
    },
    cloudfoundry: {
    ...
    entity: {
        argument: ['name'],
        desc: 'Create a new JBooter entity: JPA entity, Spring server-side components and Angular client-side components'
    },
    'export-jdl': {
        argument: ['jdlFile'],
    ...
    server: {
        desc: 'Create a new JBooter server-side application'
    },
    service: {
        argument: ['name'],
    ...
    upgrade: {
        desc: 'Upgrade the JBooter version, and upgrade the generated application'
    }
};
