...
const expectedFiles = {
    ...
    elk: [
        './ocp/monitoring/jbooter-monitoring.yml'
    ],
    eurekaregistry: [
        './ocp/registry/jbooter-registry.yml',
...
describe('JBooter OpenShift Sub Generator', () => {
    describe('only gateway', () => {
        ...
        it('creates expected registry files and content', () => {
            ...
            assert.fileContent('./ocp/registry/jbooter-registry.yml', /# base64 encoded "openshiftpaas"/);
        });
